            ...
            <Carousel className={classes.carousel} dynamicHeight infiniteLoop={true} interval={6000} useKeyboardArrows={true} transitionTime={1700} emulateTouch showArrows={false} autoPlay  showStatus={false} showThumbs={false} >
                <div  className={classes.image_container} >
                    ...
                    <div  className={classes.h1}>
                       <h1 >I'm Qasem</h1>
                       <a href="https://docs.google.com/document/d/1fX3ToF71Yr2vL8jkOtFGJYhAf75Cbyt2/edit?usp=sharing&ouid=114747780126516036328&rtpof=true&sd=true" rel="opener noreferrer" target="_blank">VIEW CV   <FaArrowCircleDown/></a>
                    </div>
                </div>
                <div className={classes.image_container}>
                    ...
                    <h1>THINGS!!</h1>
                    <a href="https://github.com/Qasem-moh" rel="opener noreferrer" target="_blank">VIEW PROJECTS   <GoProject/></a>
                    </div>
                </div>
                {/* <div className={classes.image_container}>
